            ...
            <div class="col-xl-12 col-lg-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form action="{{route('update_ingredient',$ingredient->id)}}" method="POST" enctype="multipart/form-data">
                                @csrf
                                ...
                                <div class="input-group mb-4 input-primary">
                                    ...
                                    <textarea name="measurement" class="form-control">{{$ingredient->measurement}}</textarea>
