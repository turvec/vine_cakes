                    ...
                    <div class="card-body">
                        ...
                        <form action="{{route('update_service',$service->id)}}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="input-group mb-4 input-primary">
                                    ...
                                    <input name="name" type="text" class="form-control" value="{{$service->name}}" required>
                                ...
                                <div class="input-group mb-4 input-primary">
                                    ...
                                    <input name="price" type="num" class="form-control" value="{{$service->price}}" >
                                ...
                                <div class="input-group mb-4 input-primary">
                                    ...
                                    <input name="image" type="file" class="form-control" value="{{$service->image}}" >
