                                        ...
                                        <a href="#">
                                            <div class="media d-flex align-items-center">
                                                <div class="avatar avatar-xl mr-2">
                                                    ...
                                                    src="/galleryimage/{{$gallery->image}}" width="30" alt="" />
                                                    </div>
                                                </div>
                                                <div class="media-body">
                                                    <h5 class="mb-0 fs--1">{{$gallery->title}}</h5>
                                                </div>
                                            </div>
                                        </a>
                                    </td>
                                        <td class="py-2 pl-5">{{$gallery->description}}</td>
                                        <td class="py-2">{{$gallery->created_at->format('Y/m/d')}}</td>
                                        <td class="py-2 text-right">
                                            <div class="dropdown"><button class="btn btn-primary tp-btn-light sharp"
                                                ...
                                                <div class="dropdown-menu dropdown-menu-right border py-0">
                                                    <div class="py-2">
                                                        <a class="dropdown-item" href="{{route('edit_gallery',$gallery->id)}}">Edit</a>
                                                        <a class="dropdown-item text-danger"
                                                            href="{{route('delete_gallery',$gallery->id)}}">Delete</a>
                                                    </div>
                                                </div>
                                            </div>
                                        </td>
